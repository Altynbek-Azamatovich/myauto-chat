  ...
  try {
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: "Ты полезный AI ассистент по автомобилям. Отвечай на русском языке четко и лаконично. Помогай пользователям с вопросами об автомобилях, диагностике, обслуживании и ремонте." },
          ...messages,
        ],
        stream: true,
      }),
