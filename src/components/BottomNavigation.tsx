  ...
  return (
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center bg-black/30 backdrop-blur-[10px] rounded-full p-3 min-w-[220px]">
        ...
        {/* SuperChat FAB */}
        <div className={`bg-black/30 backdrop-blur-[10px] rounded-full shadow-lg p-3 border-2 transition-colors ${
          isChatActive 
            ? "border-app-green" 
            : "border-transparent"
        }`}>
