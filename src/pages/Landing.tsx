...
const Landing = () => {
  ...
  return (
    <div className="bg-white text-gray-900 overflow-x-hidden selection:bg-blue-500/20 selection:text-blue-900" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", system-ui, sans-serif' }}>

      {/* ═══════════ HERO ═══════════ */}
      <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-16 pb-32 overflow-hidden bg-white">
        ...
        {/* Fixed CTAs - hide when footer visible */}
        <AnimatePresence>
          {showCTA && (
            <motion.div
        ...
        <div className="max-w-5xl mx-auto">
          <div className="md:flex md:items-center md:gap-20">
            <div className="md:flex-1">
              <FadeUp>
                <span className="text-blue-600 text-xs font-bold tracking-[0.2em] uppercase mb-3 block">AI Diagnostics</span>
                <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-900">
                  Диагностика{" "}
                  <span className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">по фото</span>
                </h2>
      ...
      <section className="relative py-24 md:py-36 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="md:flex md:items-center md:gap-20 md:flex-row-reverse">
            <div className="md:flex-1">
              <FadeUp>
                <span className="text-blue-600 text-xs font-bold tracking-[0.2em] uppercase mb-3 block">Smart Assistant</span>
                <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-900">
                  Auto-GPT:{" "}
                  <span className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">Твой личный механик</span>
                </h2>
                <p className="text-gray-400 text-base md:text-lg max-w-lg mb-8">
              ...
              <div className="space-y-3 mb-10 md:mb-0">
                <FadeUp delay={0.1}>
                  <div className="flex justify-end">
                    <div className="max-w-[75%] px-4 py-3 rounded-2xl rounded-br-md bg-blue-50 border border-blue-100 text-sm text-gray-700">
                ...
                <FadeUp delay={0.3}>
                  <div className="flex justify-start">
                    <div className="max-w-[75%] px-4 py-3 rounded-2xl rounded-bl-md bg-gray-50 border border-gray-100 text-sm text-gray-600">
                      ...
                      <br /><span className="text-blue-600 font-semibold">Цена — 42 990 ₸</span>
                    </div>
                  </div>
                </FadeUp>
                <FadeUp delay={0.5}>
      ...
      <section className="relative py-24 md:py-36 px-4">
        <div className="max-w-5xl mx-auto">
          <FadeUp>
            <span className="text-blue-600 text-xs font-bold tracking-[0.2em] uppercase mb-3 block">Digital Garage</span>
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-900">
              Всё в одном{" "}
              <span className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">приложении</span>
            </h2>
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-4 md:gap-4">
            {[
            { icon: Car, label: "Мой гараж", desc: "Все авто в одном месте", bg: "bg-blue-50", iconColor: "text-blue-600" },
            { icon: Shield, label: "Страховка", desc: "Напоминания и полисы", bg: "bg-emerald-50", iconColor: "text-emerald-500" },
            { icon: Wrench, label: "История ТО", desc: "Все записи сервиса", bg: "bg-slate-100", iconColor: "text-slate-600" },
        ...
        <div className="max-w-5xl mx-auto">
          <FadeUp>
            <div className="text-center mb-12">
              <span className="text-blue-600 text-xs font-bold tracking-[0.2em] uppercase mb-3 block">Ecosystem</span>
              <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-900">
                Нужный сервис{" "}
                <span className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">всегда под рукой</span>
              </h2>
          ...
          <div className="relative mb-12 overflow-hidden">
            <motion.div
              ...
              <div key={setIdx} className="flex gap-4 flex-shrink-0">
                  {[
                { icon: Wrench, name: "Автосервисы", bg: "bg-blue-50", iconColor: "text-blue-600" },
      ...
      <section className="relative py-24 px-4">
        <FadeUp>
          <div className="max-w-3xl mx-auto relative rounded-3xl overflow-hidden bg-gray-900">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 via-transparent to-blue-400/10" />
            <div className="relative p-8 md:p-16 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-sm mx-auto">
                <a href="#" className="flex items-center justify-center gap-2 px-8 py-3.5 rounded-2xl bg-blue-600 text-white font-semibold text-sm hover:bg-blue-500 transition-all shadow-[0_0_40px_rgba(37,99,235,0.3)]">
                  Скачать бесплатно
      ...
      {/* ═══════════ FOOTER ═══════════ */}
      <footer ref={footerRef} className="border-t border-gray-100 py-12 px-4 pb-12">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row md:justify-between gap-8">
            <div>
              <img src={logoFull} alt="myAuto" className="h-20 mb-4" />
