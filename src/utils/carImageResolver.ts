...
// Импорт изображений кроссоверов (12 цветов - полный набор)
...
// Импорт изображений внедорожников (12 цветов - полный набор)
...
// Импорт изображений минивенов (4 цвета, остальные fallback)
